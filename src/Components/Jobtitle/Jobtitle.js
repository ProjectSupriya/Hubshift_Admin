...
const rows = [
  createData('Aged Care Worker','dsdfssf'),
  createData('Aged Care Worker','dsdfssf'),
  createData('Aged Care Worker','dsdfssf',),
  createData('Aged Care Worker','dsdfssf'),
...
<Typography fontWeight='bold' fontSize='20px'> Job Title</Typography>


   <Box sx={{display:'flex', justifyContent:'flex-end', alignItems:'flex-end',}}>
   <Link href='addjobtitle' style={{textDecoration: 'none'}} >
                  ...
                  return (
                    <TableRow >
                      ...
                      <TableCell align="center" > 
                       <Link href='editljobtitle'> <EditIcon />  </Link> 
