...
<Paper elevation={2 } sx={{m:10,}}>
      ...
      <Grid container>
            ...
            <Box className={classes.Boxsty}>
              <Item elevation={0}>
                <Typography style={Typographysty}>
                Resignation or termination letter signed and received?
                </Typography>
              </Item>
              </Box>
            </Grid>
       ...
       <Grid container>
            ...
            <Box className={classes.Boxsty}>
              <Item elevation={0}>
                <Typography style={Typographysty}>
                Does employee agree to allow business to provide
       ...
       <Grid container>
            ...
            <Box className={classes.Boxsty}>
              <Item elevation={0}>
                <Typography style={Typographysty}>
                Termination reason and documents filed
                 filed in employee personnel folder?
                </Typography>
              </Item>
              </Box>
            </Grid>
       ...
       <Grid container>
            ...
            <Box className={classes.Boxsty}>
              <Item elevation={0}>
                <Typography style={Typographysty}>
                Employee's paper and electronic
                files moved to termination status and
                filed with term files.
                </Typography>
              </Item>
              </Box>
            </Grid>
