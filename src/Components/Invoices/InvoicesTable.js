...
function createData(Name,Item,Supportcode, Accountcode,Date,Qty,Price,Tax,Total,Status) {
  return {
    Name,Item, Supportcode, Accountcode,Date, Qty,Price, Tax, Total, Status
  };
}
...
<Box sx={{display:'flex', justifyContent:'flex-end', alignItems:'flex-end',}}>
     ...
     <Link href='/invoicestab' style={{textDecoration: 'none'}}>

    <Button sx={{ backgroundColor: "#01C1EB !important "}} variant='contained'>Generate Invoice</Button>
    </Link>

    <Link href='/invoiceviewall1' style={{textDecoration: 'none'}} >
