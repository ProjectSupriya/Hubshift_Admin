...
function createData(Item,Supportcode, Accountcode,Date,Qty,Price,Tax,Total) {
  return {
    Item, Supportcode, Accountcode,Date, Qty,Price, Tax, Total
  };
}

const rows = [
  createData('Assistance..','1234 ','3434', '11-July-2022','1','$30.00','$0.00','$30.00',),
