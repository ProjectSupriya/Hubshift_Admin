...
function createData(Sender, Receiver, Updated,) {
  return {
    Sender, Receiver,Updated,
  };
}

const rows = [
  createData('Larra Gary','Milli Chan','24-06-2022 07:46'),
  createData('Larra Gary','Milli Chan','24-06-2022 07:46'),
  createData('Larra Gary','Milli Chan','24-06-2022 07:46'),
...
<Grid item xs={2} md={2} sx={{display: { xs: 'none', md: 'flex' }}}> 
 ...
 <Typography fontWeight='bold' fontSize='22px'>Chat history</Typography>
