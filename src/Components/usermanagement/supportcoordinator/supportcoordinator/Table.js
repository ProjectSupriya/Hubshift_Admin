...
export default function EnhancedTable() {
  ...
  return (
    <Box sx={{ width: '100%' }}>
    <Typography sx={{fontWeight:"bold", fontSize:"20px",pt:2}}>Support Coordinators</Typography>
    <Box sx={{display:'flex', justifyContent:'flex-end', alignItems:'flex-end',}}>
   <Link style={{textDecoration: 'none'}} to ='/addsc'>
                ...
                .map((row, index) => {
                  ...
                  return (
                    <TableRow >
                      ...
                      <Link style={{textDecoration: 'none'}} to ='/SCEmail'>{row.Email}</Link>
                      </TableCell>
