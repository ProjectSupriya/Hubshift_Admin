      ...
      <Grid mt={8} container >
        ...
        <Grid item xs={12} md={4}>
          <Box sx={{}}>
            ...
            <img src={ProfileImage} alt="Avatar" style={{
              borderRadius: '50%', width: "200px"
            }} />

           <Box mt={2}> <EditIcon sx={{p:1,color:'blue'}}/> <DeleteIcon sx={{p:1,color:'red'}}/>  </Box> 

            </div>
            {/* <Box sx={{m:7}} > <DeleteIcon/> <EditIcon/> </Box> */}
        ...
        <Grid item xs={12} md={8}>
          ...
          <Grid container spacing={4}>
            ...
            <Grid item xs={12} md={12}>
              ...
              <Divider sx={{ mt: 4, bgcolor: 'black' }} variant="middle" />
            ...
            <Grid item xs={12} md={12}>
              ...
              <Button variant="contained"
                ...
                sx={{
                  mt: 2, backgroundColor: '#05C3DD !important',
                  color: '#FFFFFF',
                  height: "50px",
