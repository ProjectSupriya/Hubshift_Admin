      ...
      >
        ...
        <DialogContent dividers>
          ...
          11/8/2022
            ...
            <Box sx={{display:'flex',  flexDirection:'row', justifyContent:'start', alignItems:'center'}}>
            <Typography sx={{fontWeight:'bold', fontSize:'15px'}} gutterBottom >Appointment Time : </Typography> &nbsp;
          <Typography gutterBottom> 
          9:45 AM
          </Typography>
            </Box>
            ...
            <Typography sx={{fontWeight:'bold', fontSize:'15px'}} gutterBottom >Job Type :  </Typography> &nbsp;
          <Typography gutterBottom> 
          Nurse
          </Typography>
            </Box>
            <Box sx={{display:'flex', mt:1, flexDirection:'row', justifyContent:'start', alignItems:'center'}}>
            <Typography sx={{fontWeight:'bold', fontSize:'15px'}} gutterBottom >Support Worker  </Typography> &nbsp;
