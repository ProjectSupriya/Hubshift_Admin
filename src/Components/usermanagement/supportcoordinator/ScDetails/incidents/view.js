...
export default function ColumnsGrid() {
  ...
  <Typography sx={{fontSize:'40px', textAlign:"left", pb:5}}>View Incident</Typography> 
...
<Grid container spacing={2} sx={{mb:2}}>
   ...
   <Typography sx={{m:1, fontWeight:"bold"}}>Documents: </Typography>
    ...
    <Typography sx={{m:1, fontWeight:"300"}}>document.pdf</Typography>
