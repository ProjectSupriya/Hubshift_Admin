...
import Priority from "./AddhourlytaskDdown/Priority"
// import avatarImg from '../assets/profileimage.png'
import Status from "./AddhourlytaskDdown/Status"
        ...
        <>
            ...
            <Container style={{ paddingTop: "0px", paddingBottom: "0px" }}>
                ...
                <Grid container spacing={2} >
                    {/* sx={{ disply: 'flex', justifyContent: 'center', alignItems: 'center' }} */}
                    ...
                    <Grid item xs={12} md={10}>
                        ...
                        <Grid container>
                            <Grid item md={12} xs={12}>
                                <Typography fontSize="25px" fontWeight="bold">Routine Name: Exercise </Typography>
                            </Grid>



                            <Grid mt={2} item md={10} xs={12}>
                                <Typography fontSize="20px" fontWeight="bold"> Add Hourly Task </Typography>
                            ...
                            <Grid mt={2} item md={10} xs={12}>
                                ...
                                <Box sx={{
                                    ...
                                    >
                                        ...
                                        <Typography sx={{ fontWeight: 400, color: "#000", fontSize: "16px" }}>  Jane Ryan</Typography>
                                    ...
                                    >
                                        ...
                                        <Typography sx={{ fontWeight: 400, color: "#000", fontSize: "16px" }}> Tom Arren</Typography>
                                ...
                                <Box sx={{
                                    ...
                                    >
                                        ...
                                        <Typography sx={{ fontWeight: 400, color: "#000", fontSize: "16px" }}> 1 jane_2022</Typography>
                                    ...
                                    >
                                        ...
                                        <Typography sx={{ fontWeight: 400, color: "#000", fontSize: "16px" }}> Monday</Typography>
                                    ...
                                    >
                                        ...
                                        <Typography sx={{ fontWeight: 400, color: "#000", fontSize: "16px" }}> 7:00AM-8:00AM</Typography>
                            ...
                            <Grid item xs={12} md={12} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginTop: 10, }}>
                                <Button variant='contained' style={{ margin: '10px' }} className={classes.Button2}> Save </Button>
                                <Button variant='contained' style={{ margin: '10px' }} className={classes.Button2}> Add New </Button>
                            </Grid>
