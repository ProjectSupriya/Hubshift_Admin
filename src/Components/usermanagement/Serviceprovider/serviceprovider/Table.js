...
function createData(ServiceProviderID, Name,Email, Phone, Plan,StartDate, EndDate, ContractStatus,CreatedOn) {
  return {
    ServiceProviderID, Name,Email, Phone, Plan,StartDate, EndDate,  ContractStatus, CreatedOn
  };
}

const rows = [
  createData('4124','Cyndy Thomas', 'cyndy@thomas.com','1234567890','Part-Time','12-Jun-2022 ','12-Jun-2022 ', 'Disability Support Worker', 'Level1','Active','12-Jun-2022 02:00 pm'),
...
export default function EnhancedTable() {
  ...
  return (
   ...
   <Link style={{textDecoration: 'none'}} to ='/addsp'>
