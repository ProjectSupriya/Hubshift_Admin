...
import Approve from './approvepopup'
import Reject from './rejectpopup'
    ...
    <React.Fragment>
      <TableRow sx={{ '& > *': { borderBottom: 'unset' } }}>
        ...
        <TableCell component="th" scope="row">
               ...
               justifyContent: 'space-around',pb:5 }}><Visibility style={{ color: "#9b59b6", fontSize:'25px' }}/> 
               <FileDownloadIcon style={{ color: "#0C8AFF", fontSize:'25px' }}/>
               <Approve/>
              <Reject/></TableCell> 
      </TableRow>
      <TableRow>
