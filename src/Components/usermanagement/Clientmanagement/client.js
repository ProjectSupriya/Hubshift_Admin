...
function createData(Clientid, Name,Email,Phone,Category,CreatedOn , ContractStatus) {
  return {
    Clientid, Name,Email,Phone,Category, CreatedOn , ContractStatus
  };
}

const rows = [
  createData('1234','Jane Ryan','janeryan@gmail.com', '4369890532','Homecare', '12 Jun 2022,02:00 pm','Active' ),
