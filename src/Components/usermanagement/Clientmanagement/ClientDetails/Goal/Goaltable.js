...
function createData(GoalName,Duration, Status) {
  return {
    GoalName,Duration, Status 
  };
}

const rows = [
  createData('Learn Swimming','1 month','In progress'),
  createData('Improve health','3 months','Pending'),
];
...
export default function EnhancedTable() {
  ...
  return (
   ...
   <Link style={{textDecoration: 'none'}} to ='/addgoal'>
