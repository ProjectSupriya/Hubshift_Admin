...
function createData(Jobtitle,Description ) {
  return {
...
const rows = [
  createData('Casual','dsdfssf',),
  createData('Part-Time','dsdfssf'),
  createData('Casual','dsdfssf',),
  createData('Part-Time','dsdfssf'),
...
<Typography fontWeight='bold' fontSize='20px'> Job Types</Typography>


   <Box sx={{display:'flex', justifyContent:'flex-end', alignItems:'flex-end',}}>
   <Link href='addjobtype' style={{textDecoration: 'none'}} >
                  ...
                  return (
                    <TableRow >
                      ...
                      <TableCell align="center" > 
                       <Link href='editjobtype'> <EditIcon />  </Link> 
