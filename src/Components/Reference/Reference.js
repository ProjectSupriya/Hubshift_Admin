...
function createData(Number,Question ) {
  return {
    Number,Question
  };
}
...
const rows = [
  createData('1','From how many years do you know ABC?'),
  createData('2','From how many years do you know ABC?'),
...
<Typography fontWeight='bold' fontSize='20px'> Reference Form</Typography>


   <Box sx={{display:'flex', justifyContent:'flex-end', alignItems:'flex-end',}}>
   <Link href='addreference' style={{textDecoration: 'none'}} >
