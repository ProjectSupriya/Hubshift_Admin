...
function createData(level,Description ) {
  return {
    level,Description
  };
}
...
<Typography fontWeight='bold' fontSize='20px'> Level</Typography>


   <Box sx={{display:'flex', justifyContent:'flex-end', alignItems:'flex-end',}}>
   <Link href='addlevel' style={{textDecoration: 'none'}} >
                  ...
                  return (
                    <TableRow >
                      ...
                      <TableCell align="center" sx={{ display: 'flex', flexDirection: 'row',flexWrap: 'nowrap', justifyContent: 'space-around' }}> 
                       <Link href='editlevel'> <EditIcon />  </Link> 
