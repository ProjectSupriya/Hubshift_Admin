...
function createData(Num, SupportCoordinator, Person, Declaration) {
  return {
    Num, SupportCoordinator,Person, Declaration
  };
}

const rows = [
  createData('1','Irin Nova','Ben Costello','23-06-2022' ),
  createData('1','Irin Nova','Ben Costello','23-06-2022' ),
  createData('1','Irin Nova','Ben Costello','23-06-2022' ),
  createData('1','Irin Nova','Ben Costello','23-06-2022' ),
...
const headCells = [ 
  ...
  },
  {
    ...
    numeric: false,
    disablePadding: true,
    label: 'Person/Organisation with Interest',
  },
  {
    id: 'Declaration',
    numeric: false,
...
<Typography fontWeight='bold' fontSize='20px'>Conflicts of Interest Register (Need inputs from Neeraj)</Typography>


   <Box sx={{display:'flex', justifyContent:'flex-end', alignItems:'flex-end',}}>
   <Link style={{textDecoration: 'none'}} to ='/addconflict1'>
                ...
                .map((row, index) => {
                  ...
                  return (
                    <TableRow >
                      ...
                      <TableCell align="center">{row.Declaration}</TableCell>
