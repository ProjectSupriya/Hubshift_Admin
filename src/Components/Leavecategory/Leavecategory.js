...
function createData(Category,Type ) {
  return {
    Category,Type
  };
}
...
<Typography fontWeight='bold' fontSize='20px'> Leave Category </Typography>


   <Box sx={{display:'flex', justifyContent:'flex-end', alignItems:'flex-end',}}>
   <Link href='addleavecategory' style={{textDecoration: 'none'}}>
