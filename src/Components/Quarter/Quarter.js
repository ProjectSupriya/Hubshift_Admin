...
function createData(Quarter,StartDate,EndDate ) {
  return {
...
const rows = [
  createData('3rd Quarter','1-Jul-2022','30-Sep-2022'),
  createData('3rd Quarter','1-Jul-2022','30-Sep-2022'),
  createData('3rd Quarter','1-Jul-2022','30-Sep-2022'),
...
<Typography fontWeight='bold' fontSize='20px'> Set Quarter </Typography>


   <Box sx={{display:'flex', justifyContent:'flex-end', alignItems:'flex-end',}}>
   <Link href='addquarter' style={{textDecoration: 'none'}}>
                  ...
                  return (
                    <TableRow >
                      ...
                      <TableCell align="center" > 
                       <Link href='editquarter'> <EditIcon />  </Link> 
